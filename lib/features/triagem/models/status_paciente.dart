...
enum StatusPaciente {
  atendimentoEncerrado(
      'ATENDIMENTO ENCERRADO', Color.fromARGB(255, 0, 17, 255)),
  ...
  filaDeEsperaRemanescente('FILA DE ESPERA REMANESCENTE',
      const Color(0xFFD32F2F)); // Corrigido para ser constante
